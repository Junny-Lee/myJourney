			...
			<p>
				...
				&nbsp&nbsp | &nbsp&nbsp
	       		 <c:if test="${p.personal == true }">			            			
       				<a href="/posts/${p.id}/statusChangeFromPost"> <img src="https://img.icons8.com/material-two-tone/24/000000/lock--v1.png"/></a>
       			</c:if>
       			<c:if test="${p.personal == false }">			            			
       				<a href="/posts/${p.id}/statusChangeFromPost"> <img src="https://img.icons8.com/ios/24/000000/conference-call--v1.png"/></a>
       			</c:if>
			</p>
			<hr>
			<div id="text">
